const posts = [
  {
    ...
    slug: "welcome",
    title: "Whats this",
    content: "<p>This is a sveltekit test project to implement a image management tool.</p><p>Click on the Browser-button top left</p><p>You can either browse by directory or search by tags. At the bottom the results are listed, possibly on multiple pages. When you click on a thumbnail, it is shown enlarged in the center.</p>"
  },
  {
    views: 0,
    slug: "Viewer",
    title: "About the viewer",
    content: "<p>If you click on the center image in the browser, an additional Viewer-page will open and show the image in fullscale. If you open more images, they will be shown on this page too and added to the list to the left. You can switch to different images quickly be using this list.</p>"
  },
  {
    views: 0,
    slug: "Tagger",
...
export { posts as p };
//# sourceMappingURL=data2-d90509c9.js.map
